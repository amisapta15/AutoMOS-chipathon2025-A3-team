...
S {}
E {}
N 190 -20 210 -20 {lab=EN}
N 330 -20 360 -20 {lab=ENB}
...
C {libs/core_biasgen/biasgen_inverter/biasgen_inverter.sym} 210 20 0 0 {name=x3}
C {iopin.sym} 80 -230 0 1 {name=p1 lab=VDD}
C {iopin.sym} 80 -200 0 1 {name=p2 lab=VSS}
C {ipin.sym} 190 -20 0 0 {name=p3 lab=EN}
C {lab_wire.sym} 360 -20 0 1 {name=p4 sig_type=std_logic lab=ENB}
...
C {lab_wire.sym} 260 20 2 0 {name=p15 sig_type=std_logic lab=VSS}
